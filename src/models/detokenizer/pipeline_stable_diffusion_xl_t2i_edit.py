...
class StableDiffusionXLText2ImageAndEditPipeline(DiffusionPipeline, TextualInversionLoaderMixin, FromSingleFileMixin,
    ...
    def prepare_image_latents(self,
        ...
        if image.shape[1] == 4:
            ...
            if isinstance(generator, list):
                ...
                image_latents = self.vae.encode(image.float()).latent_dist.mode()
    ...
    def __call__(
        ...
        #     raise ValueError(f"Incorrect configuration settings! The config of `pipeline.unet`: {self.unet.config} expects"
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if image_latents is None:
                    image_latents = torch.zeros_like(scaled_latent_model_input)
                ...
                if do_classifier_free_guidance:
                    ...
                    noise_pred = (noise_pred_uncond + guidance_scale * (noise_pred_text - noise_pred_image) +
